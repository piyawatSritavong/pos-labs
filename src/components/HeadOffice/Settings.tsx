...
export const Settings: React.FC = () => {
  ...
  const sections = [
    ...
    { id: 'qr', label: 'QR Code Templates', icon: QrCode },
  ];
          ...
          {activeSection === 'qr' && (
            <div className="space-y-6">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900">QR Code Templates</h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    value={qrTemplate.labelSize}
                    onChange={(e) => {
                      setQRTemplate(prev => ({ ...prev, labelSize: e.target.value as any }));
                      setHasChanges(true);
                    }}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
                ...
                <div>
                  ...
                  <input
                    type="number"
                    value={qrTemplate.fontSize}
                    onChange={(e) => {
                      setQRTemplate(prev => ({ ...prev, fontSize: parseInt(e.target.value) || 12 }));
                      setHasChanges(true);
                    }}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                ...
                <div>
                  ...
                  <select
                    value={qrTemplate.fontFamily}
                    onChange={(e) => {
                      setQRTemplate(prev => ({ ...prev, fontFamily: e.target.value }));
                      setHasChanges(true);
                    }}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Price Format</label>
                  <select
                    value={qrTemplate.priceFormat}
                    onChange={(e) => {
                      setQRTemplate(prev => ({ ...prev, priceFormat: e.target.value as any }));
                      setHasChanges(true);
                    }}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
                    <option value="with-currency">With Currency (฿25.99)</option>
                    <option value="number-only">Number Only (25.99)</option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      type="color"
                      value={qrTemplate.backgroundColor}
                      onChange={(e) => {
                        setQRTemplate(prev => ({ ...prev, backgroundColor: e.target.value }));
                        setHasChanges(true);
                      }}
                      className="w-12 h-10 border border-gray-300 rounded cursor-pointer"
                    />
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      type="color"
                      value={qrTemplate.textColor}
                      onChange={(e) => {
                        setQRTemplate(prev => ({ ...prev, textColor: e.target.value }));
                        setHasChanges(true);
                      }}
                      className="w-12 h-10 border border-gray-300 rounded cursor-pointer"
                    />
              ...
              <div className="space-y-4">
                <div>
                  <label className="flex items-center space-x-2">
                    <input
                      type="checkbox"
                      checked={qrTemplate.includeBarcode}
                      onChange={(e) => {
                        setQRTemplate(prev => ({ ...prev, includeBarcode: e.target.checked }));
                        setHasChanges(true);
                      }}
                      className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                    />
                ...
                <div>
                  <label className="flex items-center space-x-2">
                    <input
                      type="checkbox"
                      checked={qrTemplate.includeLogo}
                      onChange={(e) => {
                        setQRTemplate(prev => ({ ...prev, includeLogo: e.target.checked }));
                        setHasChanges(true);
                      }}
                      className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                    />
              ...
              <div>
                ...
                <div className="border border-gray-200 rounded-lg p-6 bg-gray-50">
                  <div 
                    className="mx-auto rounded-lg p-4 text-center"
                    style={{ 
                      backgroundColor: qrTemplate.backgroundColor,
                      color: qrTemplate.textColor,
                      width: qrTemplate.labelSize === 'small' ? '200px' : qrTemplate.labelSize === 'medium' ? '300px' : '400px',
                      fontSize: `${qrTemplate.fontSize}px`,
                      fontFamily: qrTemplate.fontFamily
                    }}
                  >
                    {qrTemplate.includeLogo && (
                      <div className="mb-2">
                    ...
                    <div className="font-bold">
                      {qrTemplate.priceFormat === 'with-currency' ? '฿25.99' : '25.99'}
                    </div>
                    <div className="text-xs mt-1">Metal Roofing Sheet</div>
                    {qrTemplate.includeBarcode && (
                      <div className="mt-2">
                        <div className="h-6 bg-black mx-auto" style={{ width: '80%' }}></div>
