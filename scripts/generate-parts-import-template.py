...
EXAMPLES = [
    ...
    # An existing product: the code matches it, so this row adds 12 to the
    # warehouse and refreshes the cost/price. Name and barcode are ignored.
    # Leaving the code blank and spelling the name exactly does the same thing.
...
NOTES = [
    ...
    "• ถ้ารหัสสินค้า หรือ ชื่อสินค้า ตรงกับของที่มีอยู่แล้ว = อัปเดตของเดิม",
    "  จำนวนจะถูกบวกเพิ่มเข้าคลัง และแก้ต้นทุน/ราคาให้",
    "  ส่วนชื่อสินค้าและบาร์โค้ดจะไม่ถูกแก้ ต้องไปกดแก้ไขที่หน้าสินค้าเท่านั้น",
    "• ถ้าไม่ตรงกับอะไรเลย = สินค้าใหม่ เว้นรหัสว่างไว้ ระบบจะออกรหัสให้ (P0001, P0002, ...)",
    "• ถ้ามีหลายแถวที่ชี้ไปสินค้าตัวเดียวกัน จำนวนจะถูกรวมเข้าด้วยกัน",
