...
class ApiOperationsService {
  ...
  static Future<Map<String, dynamic>> createPosRestock({
    ...
    if (response.statusCode != 200 && response.statusCode != 201) {
      throw ApiException(
        action: 'POST /transfers/pos-restock failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<RestockCatalogPage> getRestockCatalogPage({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'GET /transfers/pos-restock/catalog failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> getVehicleDailySummary({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'GET /transfers/vehicle-daily-summary failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<List<Map<String, dynamic>>> getPurchaseOrders({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'GET /purchase-orders failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> getPurchaseOrder({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'GET /purchase-orders/$id failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> createPurchaseOrder({
    ...
    if (response.statusCode != 200 && response.statusCode != 201) {
      throw ApiException(
        action: 'POST /purchase-orders failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<void> deletePurchaseOrder({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'DELETE /purchase-orders/$id failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> getVehicleInventory({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'GET /vehicle-inventory failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> updateTransferItems({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'PUT /transfers/$id/items failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> submitTransfer({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'PUT /transfers/$id/submit failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> reviewRestockItems({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'PUT /transfers/$id/review-items failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> approveRestockTransfer({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'PUT /transfers/$id/approve-restock failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<void> logTransferPrint({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'POST /transfers/$id/print-log failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> getTransfer({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'GET /transfers/$id failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> approveTransfer({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'PUT /transfers/$id/approve failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> dispatchTransfer({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'PUT /transfers/$id/dispatch failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> receiveTransfer({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'PUT /transfers/$id/receive failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> cancelTransfer({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'PUT /transfers/$id/cancel failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> acknowledgeTransfer({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'PUT /transfers/$id/acknowledge failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<List<Map<String, dynamic>>> getStockCounts({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'GET /stock-counts failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> createStockCount({
    ...
    if (response.statusCode != 200 && response.statusCode != 201) {
      throw ApiException(
        action: 'POST /stock-counts failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> getStockCount({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'GET /stock-counts/$id failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> updateStockCountItems({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'PUT /stock-counts/$id/items failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> submitStockCount({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'PUT /stock-counts/$id/submit failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<List<Map<String, dynamic>>> getDailyCloses({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'GET /daily-closes failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> getDailyCloseSummary({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'GET /daily-closes/summary failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> createDailyClose({
    ...
    if (response.statusCode != 200 && response.statusCode != 201) {
      throw ApiException(
        action: 'POST /daily-closes failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> getDailyClose({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'GET /daily-closes/$id failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<List<Map<String, dynamic>>> getCashReconciliations({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'GET /cash-reconciliations failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> createCashReconciliation({
    ...
    if (response.statusCode != 200 && response.statusCode != 201) {
      throw ApiException(
        action: 'POST /cash-reconciliations failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> getCashReconciliation({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'GET /cash-reconciliations/$id failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
  ...
  static Future<Map<String, dynamic>> getStockVariance({
    ...
    if (response.statusCode != 200) {
      throw ApiException(
        action: 'GET /reports/stock-variance failed',
        statusCode: response.statusCode,
        body: response.body,
      );
    }
